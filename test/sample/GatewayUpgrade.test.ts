...
import { Gateway_V1_05 } from "../../typechain-types";

const gatewayProxyAddress = "0x1FB8c2BA3bee2b5Df4310e032ddF108Cf0f5ff6e";
const newVersionName = "Gateway v1.05";
const newContractName = "Gateway_V1_05";
// const newContractPath = "\\contracts\\gateway\\upgradeable\\v1.05\\Gateway_V1_05.sol";
let gw:Gateway_V1_05;
...
describe("GatewayUpgrade", async function () {
    ...
    //     printAbi(config.paths.artifacts.concat("\\contracts\\gateway\\upgradeable\\v1.04\\Gateway_V1_04.sol\\Gateway_V1_04.json"), true);
