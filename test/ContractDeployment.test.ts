...
// /// Proxy Contract (common)
// import { STOProxy } from "../typechain-types/contracts/proxy/STOProxy";
...
describe("Contract Deployment", async function () {
    before(async function() {
        ...
        const factoryWhite = await ethers.getContractFactory("Whitelist", {signer: deployer});
        whitelist = await factoryWhite.connect(deployer).deploy();
        await whitelist.waitForDeployment();
